...
$.fn.xb_scroll = function(options)
{
	...
	var jqScrollBox = $("<div style='position:absolute;width:"+opts.boxWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;bottom:"+opts.barOffBottom+"px;border-radius: 5px;background: #f4f4f4;'></div>");
	jqScrollBox.addClass(opts.boxClass);
	var jqScrollBar= $("<div style='position:absolute;width:"+opts.barWidth+"px;top:"+opts.barOffTop+"px;right:"+opts.barOffRight+"px;border-radius: 5px;background: #f4950a;'></div>");
	...
	jqScrollBar.on("mousedown",function(ev){
		...
		jqScrollBar.css({"background":"#f4950a"});
